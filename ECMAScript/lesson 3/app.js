...
console.log(order.getTotalPrice()); // 1100

// проверка на другой ордер
const order2 = new Order(123445);
const product3 = new Product("Headphones", 200, 2);
order2.addProduct(product3);

console.log(order2.getTotalPrice()); // 400
